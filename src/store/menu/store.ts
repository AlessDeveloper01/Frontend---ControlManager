import { CategoryInProduct, OrderItemType } from "@/src/Objects";
...
export type MenuStore = {
    ...
    setProducts: (products: CategoryInProduct) => void
    order: OrderItemType[]
...
export const useMenu = create<MenuStore>()(devtools((set) => ({
    categories: [] as CategoryInProduct[],
    setCategories: (categories) => set({ categories }),
    products: {} as CategoryInProduct,
